    ...
    if not comb_agent:
        ...
        tools = [
            build_tool(
                ...
                FetchSourceArgs,
                lambda fn_name, file_path=None: fetch_source_snippet(fn_id = fn_name, 
                                                     G=G, 
                                                     metadata = metadata,
                                                     repo_path=repo_path,
                                                     file_hint=file_path),
            ...
            build_tool(
                ...
                LookaroundSourceArgs,
                lambda fn_name, context_lines=30, file_path=None: lookaround_source_snippet(fn_id = fn_name, 
                                                                      G=G, 
                                                                      metadata = metadata, 
            ...
            build_tool(
                ...
                GrepContext,
                lambda query, file_path=None, page=1: grep_ast(query = query,
                                                    file_hint = file_path,
                                                    repo_path=repo_path,
                                                    page=page),
            ),
